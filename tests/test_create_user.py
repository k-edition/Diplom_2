...
class TestCreateUser:
    ...
    def test_create_user_duplicate(self, get_payload, remove_user):
        ...
        assert response_duplicate.status_code == 403 and data.text[403][0] in response_duplicate.text
    ...
    def test_create_user_empty_email(self):
        ...
        assert response.status_code == 403 and data.text[403][1] in response.text
